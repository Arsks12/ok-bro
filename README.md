...
- `EXTENSION_FILTER`: File extentions that won't upload/clone. Separate them by space.
...
### GDTOT
- `GDTOT`: Cookie for gdtot google drive link generator. Follow these [steps](https://github.com/anasty17/mirror-leech-telegram-bot/tree/master#gdtot-cookies).
...
3. Now you'll get Crypt value in your clipboard
   ...
   ```
4. From this you have to paste value for **GDTOT** in config.env file.
